...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const state = {
        ...
        predefinedLocations: [
            ...
            { id: 42, name: "Lovely Professional University (LPU)",coords: [31.2520, 75.7050], priority: 'High',   type: 'pickup',    icon: '🎓' },
            { id: 43, name: "Phagwara Industrial Area",           coords: [31.2300, 75.7900], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 44, name: "Kapurthala Railway Station",         coords: [31.3800, 75.3800], priority: 'Medium', type: 'pickup',    icon: '📦' },
            { id: 45, name: "Kapurthala Market",                  coords: [31.3750, 75.3850], priority: 'Medium', type: 'delivery',  icon: '📍' },
            // ── HOSHIARPUR / NAWANSHAHR ──
            { id: 46, name: "Hoshiarpur Bus Stand",               coords: [31.5300, 75.9100], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 47, name: "Hoshiarpur Industrial Area",         coords: [31.5400, 75.9300], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 48, name: "Nawanshahr Market",                  coords: [31.1200, 76.1200], priority: 'Medium', type: 'delivery',  icon: '📍' },
            // ── GURDASPUR / PATHANKOT ──
            { id: 49, name: "Gurdaspur Bus Stand",                coords: [32.0400, 75.4100], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 50, name: "Pathankot Railway Station",          coords: [32.2700, 75.6500], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 51, name: "Pathankot Industrial Area",          coords: [32.2800, 75.6700], priority: 'High',   type: 'pickup',    icon: '📦' },
            // ── FIROZPUR / FAZILKA ──
            { id: 52, name: "Firozpur City Market",               coords: [30.9200, 74.6000], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 53, name: "Fazilka Bus Stand",                  coords: [30.4000, 74.0300], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 54, name: "Abohar Market",                      coords: [30.1400, 74.1900], priority: 'Medium', type: 'delivery',  icon: '📍' },
            // ── SANGRUR / BARNALA ──
            { id: 55, name: "Sangrur Bus Stand",                  coords: [30.2500, 75.8400], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 56, name: "Sangrur Industrial Area",            coords: [30.2600, 75.8600], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 57, name: "Barnala Bus Stand",                  coords: [30.3800, 75.5500], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 58, name: "Barnala Grain Market",               coords: [30.3750, 75.5450], priority: 'High',   type: 'pickup',    icon: '📦' },
            // ── MOGA / FARIDKOT ──
            { id: 59, name: "Moga Bus Stand",                     coords: [30.8200, 75.1700], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 60, name: "Moga Industrial Area",               coords: [30.8300, 75.1900], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 61, name: "Faridkot Bus Stand",                 coords: [30.6700, 74.7600], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 62, name: "Faridkot Grain Market",              coords: [30.6650, 74.7550], priority: 'High',   type: 'pickup',    icon: '📦' },
            // ── MUKTSAR / MALOUT ──
            { id: 63, name: "Sri Muktsar Sahib Bus Stand",        coords: [30.4800, 74.5200], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 64, name: "Malout Market",                      coords: [30.2000, 74.4800], priority: 'Medium', type: 'delivery',  icon: '📍' },
            // ── ROPAR / MORINDA ──
            { id: 65, name: "Ropar Bus Stand",                    coords: [30.9700, 76.5200], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 66, name: "Ropar Industrial Area",              coords: [30.9800, 76.5400], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 67, name: "Morinda Market",                     coords: [30.7900, 76.4900], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 68, name: "Anandpur Sahib",                     coords: [31.2400, 76.5000], priority: 'Low',    type: 'delivery',  icon: '📍' },
            // ── FATEHGARH SAHIB / SIRHIND ──
            { id: 69, name: "Fatehgarh Sahib Bus Stand",          coords: [30.6500, 76.3900], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 70, name: "Sirhind Industrial Area",            coords: [30.6300, 76.3800], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 71, name: "Mandi Gobindgarh Steel Market",      coords: [30.6700, 76.3100], priority: 'High',   type: 'pickup',    icon: '📦' },
            // ── TARN TARAN ──
            { id: 72, name: "Tarn Taran Bus Stand",               coords: [31.4500, 74.9300], priority: 'Medium', type: 'delivery',  icon: '📍' },
            // ── HIGHWAY JUNCTIONS ──
            { id: 73, name: "Khanna Grain Market",                coords: [30.7050, 76.2200], priority: 'High',   type: 'pickup',    icon: '📦' },
            { id: 74, name: "Samrala Market",                     coords: [30.8400, 76.1900], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 75, name: "Phillaur Bridge Junction",           coords: [31.0200, 75.7900], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 76, name: "Nakodar Market",                     coords: [31.1300, 75.4700], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 77, name: "Sultanpur Lodhi",                    coords: [31.2100, 75.1900], priority: 'Low',    type: 'delivery',  icon: '📍' },
            { id: 78, name: "Nangal Township",                    coords: [31.4900, 76.3700], priority: 'Medium', type: 'delivery',  icon: '📍' },
            { id: 79, name: "Rupnagar Grain Market",              coords: [30.9650, 76.5250], priority: 'High',   type: 'pickup',    icon: '📦' },
        ],
        analytics: {
            distanceChart: null,
